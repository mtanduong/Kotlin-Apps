package com.mtanduong.calculatorapp
...
//Import pulls in widgets(buttons, views, etc) via cache and stores references to widgets so no need to instantiate widgets
...
//
//        //Data input buttons (one way to declare and initialize)
...
//
//        //Operation buttons (another way to declare and initialize)
//        val buttonEquals = findViewById<Button>(R.id.buttonEqual)
//        val buttonDivide = findViewById<Button>(R.id.buttonDivide)
//        val buttonMultiply = findViewById<Button>(R.id.buttonMultiply)
//        val buttonMinus = findViewById<Button>(R.id.buttonSubtract)
//        val buttonPlus = findViewById<Button>(R.id.buttonAdd)
        ...
        //Textview is numberSigned|numberDecimal so it ensures its only a single decimal allowed
